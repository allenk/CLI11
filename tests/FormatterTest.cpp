...
TEST(Formatter, Nothing) {
    ...
    app.formatter(
        [](const CLI::App *, std::string, CLI::App::Formatter::Mode) { return std::string("This is really simple"); });
...
TEST(Formatter, AllSub) {
    ...
    std::string help = app.help("", CLI::App::Formatter::Mode::All);
